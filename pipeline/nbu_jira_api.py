...
FIELDS = [
    ...
    'customfield_10014',  # Epic Link (ключ эпика для Story/Task)
    'customfield_10008',  # Epic Link (альтернативное поле)
...
for issue in all_issues:
    ...
    rows.append({
        ...
        'Epic Link':  str(f.get('customfield_10014') or '').strip(),
        'Epic Link 2': str(f.get('customfield_10008') or '').strip(),
